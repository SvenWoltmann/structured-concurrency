...
public class InvoiceGenerator4b_NewVirtualThreadPerTaskCancelling_NoHints {

  static void main() throws Throwable {
    InvoiceGenerator4b_NewVirtualThreadPerTaskCancelling_NoHints invoiceGenerator =
        new InvoiceGenerator4b_NewVirtualThreadPerTaskCancelling_NoHints(
  ...
  public InvoiceGenerator4b_NewVirtualThreadPerTaskCancelling_NoHints(
